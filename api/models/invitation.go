...
func (m *Invitation) contextValidateInviteeNickname(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "invitee_nickname", "body", m.InviteeNickname); err != nil {
		return err
	}
...
func (m *Invitation) contextValidateInviterNickname(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "inviter_nickname", "body", m.InviterNickname); err != nil {
		return err
	}
...
func (m *Invitation) contextValidateSessionName(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "session_name", "body", m.SessionName); err != nil {
		return err
	}
