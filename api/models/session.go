...
var sessionTypeStatePropEnum []any
...
func (m *Session) contextValidatePendingInvitation(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "pending_invitation", "body", m.PendingInvitation); err != nil {
		return err
	}
...
func (m *Session) contextValidatePlayers(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "players", "body", m.Players); err != nil {
		return err
	}
